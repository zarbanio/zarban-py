...
class PersonalSignRequest(object):
    ...
    def message(self):
        ...
        :return: The message of this PersonalSignRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this PersonalSignRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PersonalSignRequest):
            return False
