...
class PricesApi(object):
    ...
    def list_prices(self, **kwargs):  # noqa: E501
        ...
        return self.list_prices_with_http_info(**kwargs)  # noqa: E501

    def list_prices_with_http_info(self, **kwargs):  # noqa: E501
        """List prices based on query parameters  # noqa: E501

        Retrieve a list of price details based on specified query parameters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_prices_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PriceListResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='PriceListResponse',  # noqa: E501
