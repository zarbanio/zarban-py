...
class User(object):
    ...
    def __init__(self, first_name=None, last_name=None, email=None, username=None, phone=None, is_email_verified=None, is_phone_verified=None, is_kyc_verified=None, is_child=None, is_super_user=None, telegram=None, local_vars_configuration=None):  # noqa: E501
