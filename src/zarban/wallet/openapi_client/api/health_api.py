...
class HealthApi(object):
    ...
    def check_api_health(self, **kwargs):  # noqa: E501
        """Health check  # noqa: E501

        Check the health of the API.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.check_api_health(async_req=True)
        >>> result = thread.get()
        ...
        return self.check_api_health_with_http_info(**kwargs)  # noqa: E501

    def check_api_health_with_http_info(self, **kwargs):  # noqa: E501
        """Health check  # noqa: E501

        Check the health of the API.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.check_api_health_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method check_api_health" % key
                )
